...
function listarVagas(params, fucione) {
...
function novaVaga() {
  ...
  const dataLimite = prompt('Informe uma data limite (dd/mm/aaaa) para vaga:')
...
function exibirVaga() {
  const indice = prompt('Informe um índice da vaga que deseja exibir:')
